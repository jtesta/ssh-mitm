...
DOCKER_ENV = {'DOCKER_HOST': 'unix:///home/ssh-mitm/.docker/run/docker.sock'}
...
class ClientHandler(threading.Thread):
    ...
    def _run(self):
        ...
        with subprocess.Popen(DOCKER_CMD, env=DOCKER_ENV, bufsize=0, shell=False, stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.PIPE) as hDocker:
...
os.fchmod(sock.fileno(), 0o700)  # Set socket permission to 0700.
sock.bind(MASTER_SOCKET_PATH)
sock.listen(32)
